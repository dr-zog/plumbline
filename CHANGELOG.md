...
Notable changes to Plumbline. From `0.2.1` on, this file is **generated by
[semantic-release](https://semantic-release.gitbook.io/)** from
[Conventional Commits](https://www.conventionalcommits.org/) at each release
([ADR 005](docs/adrs/005-automated-releases-semantic-release.md)) — don't hand-edit it.
The `0.1.0` and `0.2.0` sections below are the hand-authored history from before the
switch. Versioning follows [Semantic Versioning](https://semver.org/spec/v2.0.0.html)
